...
// Component for managing product sizes
  ...
  return (
    ...
    >
      <div className="bg-white shadow-md rounded-lg p-6">
        <h4 className="text-xl font-semibold mb-4 text-gray-800">Sizes</h4>
        <div className="space-y-6">
            ...
            >
              <div className="col-span-3">
                ...
                <input
                  ...
                  value={size.name || ""}
                  onChange={(e) =>
                    handleInputChange(index, "name", e.target.value, setSizes)
                  }
                />
              </div>
              <div className="col-span-6">
                ...
                <input
                  ...
                  value={size.price || ""}
                  onChange={(e) =>
                    handleInputChange(index, "price", e.target.value, setSizes)
                  }
                />
              </div>
              <div className="col-span-3">
          ...
          {sizes.length < 1 && (
            <h4 className="text-lg text-gray-600">No Size Added</h4>
          )}
          <button
            type="button"
          ...
          >
            <i className="fas fa-plus mr-2" /> Add More Sizes
          </button>
        </div>
      </div>
    </div>
...
// This component manages the sizes section of the product form.
// It receives the sizes state and handler functions as props.
// The sizes state is an array of objects with name and price fields.
// The handleInputChange function updates the size fields dynamically.
// The handleRemove function removes a size entry from the array.
// The handleAddMore function adds a new empty size entry.
...
// The Remove button allows deletion of individual size entries.
// The Add More Sizes button enables dynamic addition of fields.
...
// The sizes are stored in an array for easy form data submission.
...
// The sizes section is critical for products with variable sizing options.
...
// The placeholder values guide users in entering size and price data.
// The component supports dynamic form fields for flexible size management.
