    ...
    <>
      {cartItems.map((c) => {
        ...
        return (
          <div
            key={c.id}
            className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-4 p-6 hover:bg-gray-50 transition-colors group items-center"
          >
            {/* Product Info (Col 6) */}
            <div className="md:col-span-6 flex gap-4">
              ...
              <div className="flex flex-col justify-center">
                <Link
                  ...
                  className="font-bold text-gray-900 line-clamp-2 hover:text-blue-600 transition-colors mb-1"
                >
                  {c.product.title}
                </Link>
                <div className="text-sm text-gray-500 mb-2">
                  {hasSize && (
                    <span className="mr-3 bg-gray-100 px-2 py-0.5 rounded text-xs">
                      Size: {sizeName}
                    </span>
                  )}
                  {hasColor && (
            ...
            <div className="md:col-span-3 flex items-center justify-between md:justify-center">
              ...
              <div className="flex items-center border border-gray-200 rounded-lg bg-white">
                <button
                  onClick={() =>
                    handleQtyChange(c.product.id, Number(currentQty) - 1)
                  }
