      ...
      <div className="relative bg-gray-900 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32 flex flex-col items-center text-center">
          ...
          <p className="max-w-2xl text-lg md:text-xl text-gray-300 mb-10 leading-relaxed">
            Your destination for authentic vintage treasures. From retro cameras
            to classic vinyls, find the pieces that tell a story.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-sm text-gray-500">
                Every item verified by experts.
              </p>
            </div>
            <div className="flex flex-col items-center">
        ...
        <div className="flex justify-between items-end mb-10">
          <div>
            ...
            <p className="mt-2 text-gray-500">
              Browse by your favorite era or style.
            </p>
          </div>
          <Link
            to="/category"
            className="hidden sm:flex items-center text-blue-600 font-medium hover:text-blue-700 group"
          >
            View All{" "}
      ...
      <div className="bg-gray-50 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-end mb-10">
            ...
            <Link
              to="/products"
              className="sm:flex items-center text-blue-600 font-medium hover:text-blue-700 group"
            >
              Shop All{" "}
              <ArrowRight className="ml-1 h-4 w-4 group-hover:translate-x-1 transition-transform" />
            </Link>
